        ...
        children: [
          Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    IconButton(onPressed: (){setState(() {post1[0]= !post1[0];});}, icon: Icon(post1[0] ? Icons.favorite_rounded : Icons.favorite_outline_outlined,color: post1[0] ? Colors.red : Colors.black)),
                    IconButton(onPressed: (){}, icon: const Icon(Icons.comment_outlined)),
                    IconButton(onPressed: (){}, icon: const Icon(Icons.send)),
                    const Spacer(),
                    IconButton(onPressed: (){setState(() {post1[1]= !post1[1];});}, icon: post1[1] ? const Icon(Icons.bookmark_rounded, color: Colors.black,) : const Icon(Icons.bookmark_outline)),
                  ],
                )
              ],
            ),
            
            const Text("10342 likes"),
            const Text("#FriendshipGoals Partners in Crime"),
            const Text("see all Comments",style: TextStyle(fontSize: 10,fontStyle: FontStyle.italic,),),
            const Text("1 day ago",style: TextStyle(fontSize: 10,fontStyle: FontStyle.italic,),),
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    IconButton(onPressed: (){setState(() {post2[0]= !post2[0];});}, icon: post2[0] ? const Icon( Icons.favorite_rounded,color: Colors.red,) : const Icon(Icons.favorite_outline_outlined)),
                    IconButton(onPressed: (){}, icon: const Icon(Icons.comment_outlined)),
                    IconButton(onPressed: (){}, icon: const Icon(Icons.send)),
                    const Spacer(),
                    IconButton(onPressed: (){setState(() {post2[1]= !post2[1];});}, icon: post2[1] ? const Icon(Icons.bookmark_rounded, color: Colors.black,) : const Icon(Icons.bookmark_outline)),
                  ],
                )
              ],
            ),

            const Text("16342 likes"),
            const Text("#FriendshipGoals"),
            const Text("see all Comments",style: TextStyle(fontSize: 10,fontStyle: FontStyle.italic,),),
            const Text("1 day ago",style: TextStyle(fontSize: 10,fontStyle: FontStyle.italic,),),
            const SizedBox(height: 10,),
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    IconButton(onPressed: (){setState(() {post3[0]= !post3[0];});}, icon: Icon(post3[0] ? Icons.favorite_rounded : Icons.favorite_outline_outlined,color: post3[0] ? Colors.red : Colors.black)),
                    IconButton(onPressed: (){}, icon: const Icon(Icons.comment_outlined)),
                    IconButton(onPressed: (){}, icon: const Icon(Icons.send)),
                    const Spacer(),
                    IconButton(onPressed: (){setState(() {post3[1]= !post3[1];});}, icon: post3[1] ? const Icon(Icons.bookmark_rounded, color: Colors.black,) : const Icon(Icons.bookmark_outline)),
                  ],
                )
              ],
            ),
            const Text("12342 likes"),
            const Text("#Partners in Crime"),
            const Text("see all Comments",style: TextStyle(fontSize: 10,fontStyle: FontStyle.italic,),),
            const Text("1 day ago",style: TextStyle(fontSize: 10,fontStyle: FontStyle.italic,),),
            const SizedBox(height: 10,),
